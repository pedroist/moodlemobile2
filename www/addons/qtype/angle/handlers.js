...
/**
 * Angle question handlers.
 *
 * @module mm.addons.qtype_angle
 * @ngdoc service
 * @name $mmaQtypeAngleHandler
 */
.factory('$mmaQtypeAngleHandler', function($mmUtil) {
    ...
    self.isCompleteResponse = function(question, answers) {
        if (!self.isGradableResponse(question, answers)) {
            return false;
        }

...
.factory('$mmPhotoUploader', function($mmSite, $mmFS, $mmUtil, $q, $timeout, $log, $mmSitesManager, $mmQuestionHelper) {
     ...
     * @ngdoc method
     * @name $mmPhotoUploader#uploadFile
     ...
     * @module mm.core.photouploader
     * @ngdoc method
     * @name $mmPhotoUploader#uploadImage
    ...
    self.uploadImage = function(uri, isFromAlbum) {
        ...
        if (typeof uri == 'undefined' || uri === ''){
            ...
            $log.debug('Received invalid URI in $mmPhotoUploader.uploadImage()');
            return $q.reject();
        }
     ...
     * @module mm.core.photouploader
     * @ngdoc method
     * @name $mmPhotoUploader#uploadMedia
     ...
     * @module mm.core.photouploader
     * @ngdoc method
     * @name $mmPhotoUploader#uploadGenericFile
     * @param  {String} uri                File URI.
